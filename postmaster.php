<?php
$EMAIL = 'romacastor@gmail.com'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'romacastor@gmail.com';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'romacastor@gmail.com';   //  e-mail для ответа 
